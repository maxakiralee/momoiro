...
const posts = [
  ...
  },
  {
    ...
    href: '#',
    description:
      'Come volunteer at our weekly Kahalui Food Drive to help displaced and under-privileged Maui Residents!',
    imageUrl:
...
export default function Latest() {
  return (
    <div className="bg-gradient-to-r from-blue-300 to-blue-100 py-24 sm:py-24">
        ...
        <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-3">
          {posts.map((post) => (
            <article key={post.id} className="flex flex-col items-start justify-between">
              <div className="relative w-full transform transition-transform hover:scale-105">
                <img
                  src={post.imageUrl}
                  alt=""
              ...
              <div className="max-w-xl">
                <div className="mt-8 flex items-center gap-x-4 text-xs font-bold text-black">
                  <time dateTime={post.datetime} className="text-black font-bold">
                    {post.date}
                  </time>
                  <a
                ...
                <div className="group relative">
                  <h3 className="mt-3 text-2xl font-extrabold leading-6 text-gray-900 group-hover:text-gray-700">
                    <a href={post.href}>
